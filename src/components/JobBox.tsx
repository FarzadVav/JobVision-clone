...
const JobBox = ({ id, categories, title, company, city, location, salary, remote, isUrgent, companyScore }: JobsTypes) => {
  ...
  return (
    <article
      ...
      className={`bg-white w-full p-2 group`}
    >
      <Link
      ...
      >
        <div className={`flex`}>
          <div className={`col-span-3 flex flex-col items-center`}>
            <div className={`bg-jv-light w-20 h-20 flex justify-center items-center rounded-md`}>
              <img
        ...
        <div className={`border-t border-solid border-jv-light col-span-12 flex justify-between items-center pt-3 mt-5`}>
          ...
          {
            companyScore ? (
              <span className={`badge text-jv-success ml-auto opacity-0 group-hover:opacity-100`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth={0} stroke="currentColor" className={`w-4 h-4 mr-0`}>
