  ...
  return (
    <div className={`wrapper flex my-12`}>
      <aside className={`bg-jv-primary w-3/12 h-max flex flex-col justify-center items-center p-5 rounded-md sticky top-[5.25rem] overflow-hidden`}>
        <div className={`bg-jv-bright w-20 h-20 flex justify-center items-center rounded-full relative`}>
          <img
            className={`w-32 h-32 object-cover object-center rounded-full absolute blur-2xl opacity-60`}
