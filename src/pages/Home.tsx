	...
	return (
		<>
			<div className={`wrapper mt-5`}>
				...
				{/* employment baner */}
				<div className={`bg-jv-light flex flex-col-reverse justify-center items-center mt-16 px-3 py-9 rounded-md
				md:flex-row md:justify-evenly`}>
					<div className={`flex flex-col justify-center items-center md:items-start md:w-1/2`}>
						<h3 className={`dana-bold text-xl`}>
							استخدام‌های سراسری و دولتی
						</h3>
						<p className={`mt-3 text-sm text-center md:text-right`}>
